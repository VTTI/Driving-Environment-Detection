...
<table style="padding: 10px">
    <tr>
        <td> <img src="./Images/baseline_1_saliency/Saliency_urban.png"  alt="1" width="350" height="600"></td>
    </tr>
</table>
...
<table style="padding: 10px">
    <tr>
        <td> <img src="./Images/baseline_1_saliency/Saliency_residential.png"  alt="1" width="350" height="600"></td>
    </tr>
</table>
