...
def get_grad_cam(model, target_layer, image_path, target_category=None):
    ...
    :return: cam
    """
    out = os.path.join("/vtti/projects03/451600/Data/Dump/Locality_Saliency", f"output{target_category}")
...
if __name__ == "__main__":
    ...
    path =  os.path.join('/vtti/projects03/451600/Data/Dump/Locality_Saliency','Interstate')
    ...
    weight = "/vtti/projects03/451600/Data/Dump/Locality_Results/output/baseline/resnext50/weights/LR_0.001_OPT_ASGD_BATCH_32_SHAPE_(240, 360)__/LR_0.001_OPT_ASGD_BATCH_32_SHAPE_(240, 360)___best_weight.pth"
    ...
    for idx, img in enumerate(os.listdir(path)):
        ...
        if events_.count(img.split('_')[2]) > 1 :
            continue

        get_grad_cam(model=net, target_layer=target, image_path=img_path, target_category=2)
